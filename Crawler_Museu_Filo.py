...
Original file is located at
    https://colab.research.google.com/drive/1tNA5SbJ4xAr6WVH8cl9wXgOQebmXHR7I
"""
...
def coleta_info(id_index, contador, startIndex, n_registros, caminho): 
          ...
          if img.has_attr('src'):
            ...
            if os.path.exists(filo):
              ...
              if response.status_code == 200:
                with open(filo+"/"+filo+"_Img_00"+id+jpg, 'wb') as f:
                  nome_foto = filo+"_Img_00"+id+jpg
              ...
              response = requests.get(url_img_400)
              if response.status_code == 200:
                with open(filo+"_Img_00"+id+jpg, 'wb') as f:
                  nome_foto = filo+"_Img_00"+id+jpg
                  f.write(response.content)
              ...
              os.chdir(caminho+"/Coletas/Coleta_"+data_atual) 
...
if __name__ == '__main__':
  caminho = str(input("Digite o caminho em que deseja salvar as imagens: "))
  ...
  coleta_info(contador, id_index, startIndex, n_registros, caminho)
